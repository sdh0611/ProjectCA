...
//메커니즘을 바꿔야할 것 같은데..
bool CCollisionManager::BoxAndBox(std::shared_ptr<CActor> pActor, std::shared_ptr<CActor> pOther)
{
	...
	const Types::Rect& box1 = collider1->GetRect();
	const Types::Rect& box2 = collider2->GetRect();
